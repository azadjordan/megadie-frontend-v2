          ...
          return (
            ...
            >
              <span className="inline-flex flex-col items-start">
                <span
                  className={[
                    'relative z-10 inline-flex items-center rounded-full px-3 py-1 text-[13px] font-semibold ring-1 transition-all',
                    isActive
                ...
                {explanation ? (
                  <span
                    className={[
                      'relative z-0 -mt-0.5 ml-2 inline-flex items-center rounded-b-lg rounded-tr-lg border px-2 py-0.5 text-[11px] leading-tight opacity-90 shadow-sm transition-all',
                      isActive
