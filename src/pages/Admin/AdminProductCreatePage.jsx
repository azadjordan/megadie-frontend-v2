...
export default function AdminProductCreatePage() {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      setSubmitError(
        err?.data?.message || err?.error || "Unable to create product."
      );
    }
  };
      ...
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <div className="text-sm text-slate-500">
            Fill the steps below and submit once at the end.
          </div>
        </div>
      </div>
        ...
        <div className="mt-3 grid gap-3 md:grid-cols-2">
          <div className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
            ...
            <div className="mt-1 break-all text-sm font-semibold text-slate-900">
              {preview.sku || "SKU will be generated"}
            </div>
          </div>
          <div className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2">
            <div className="text-[10px] font-semibold uppercase text-slate-500">
            ...
            <div className="mt-1 text-sm font-semibold text-slate-900">
              {preview.name || "Name will be generated"}
            </div>
          </div>
        </div>
        ...
        {step.key === "review" ? (
          <div className="space-y-4 text-sm text-slate-700">
            <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
              SKU and name will be generated automatically from the fields you
              entered.
            </div>
